      ...
      <div className="flex items-center justify-between h-16 px-4">
        {isMobile && (
          <button 
            ...
            className="p-2 rounded-md hover:bg-accent text-brand-primary"
          >
            <Menu size={20} />
          </button>
        )}
        ...
        <div className="flex-1 md:ml-4">
          <h1 className="text-lg font-medium text-brand-text">Drop & Ship Admin</h1>
        </div>
        
        <div className="flex items-center space-x-3">
          <button className="p-2 rounded-full hover:bg-accent relative text-brand-primary">
            <Bell size={20} />
